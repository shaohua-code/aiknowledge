...
export interface ModelConfiguration {
  chatProvider: 'disabled' | 'openai' | 'openai_compatible'
  chatModel: string
  chatBaseUrl: string
  chatApiKeyConfigured: boolean
  embeddingProvider: 'local_hash' | 'openai' | 'openai_compatible'
  embeddingModel: string
  embeddingBaseUrl: string
  embeddingApiKeyConfigured: boolean
  webSearchProvider: 'disabled' | 'serper'
  webSearchBaseUrl: string
  webSearchApiKeyConfigured: boolean
}

export interface ModelConfigurationUpdate {
  chatProvider: ModelConfiguration['chatProvider']
  chatModel: string
  chatBaseUrl: string
  chatApiKey?: string
  ...
  webSearchProvider: ModelConfiguration['webSearchProvider']
  webSearchBaseUrl: string
